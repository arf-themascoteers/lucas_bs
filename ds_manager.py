...
class DSManager:
    def __init__(self, name="lucas",folds=1,scale_y="robust",shuffle=True,train_split=0.75):
        self.name = name
    ...
    def get_k_folds(self):
        for i in range(self.folds):
            train_data, test_data = train_test_split(self.data, train_size=self.train_split, random_state=42+i)
